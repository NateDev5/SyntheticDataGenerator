...
import { SyntheticDataGenerator, Interface, Mutator, WeightedMutator, RangeMutator } from "../data_generator/SyntheticDataGenerator";
${Tags.plugins}
...
export const GenerateWithMutatorsTemplate: Template = {
    content: `GenerateWithMutators(f: string | Interface, m: Mutator[], c: number): any {
